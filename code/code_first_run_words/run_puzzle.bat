...
puzzle.py test3 130 --process initial_grid --max_closest 8 --nr_trials_re_init 30 --stop_nr_trials 59 --to_file_trials 3 --old_grid_size 10 --dif_output_dir test3_memory